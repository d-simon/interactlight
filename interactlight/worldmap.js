...
WorldMap.prototype.increaseUntil = function (inputVal, max, n) {
    var n = n || 1;
    return (inputVal < max) ? inputVal + n : max;
}
WorldMap.prototype.reduceUntilMin = function (inputVal, min, n) {
    var min = min || 50;
    var n = n || 1;
    return (inputVal > min) ? inputVal - n : min;
}
WorldMap.prototype.reduceUntilZero = function (inputVal, n) {
    var n = n || 1;
    return (inputVal > n) ? inputVal - n : 0;
}
WorldMap.prototype.reduceUntilMinOrZero = function (inputVal, min, n) {
    var min = min || 50;
    var n = n || 1;
